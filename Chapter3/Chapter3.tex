...
\section{The emancipatory potential of music}
%\section{The Musical Avant-Garde}

A central concern that derives from Ranci\`{e}re's analysis between aesthetics and politics is how to reinvigorate the \emph{modernist} idea of the avant-garde without falling back to the misunderstandings that led to the `crisis of modernity.' To avoid these misunderstandings, one needs to take special care and remember the clear differentiation Ranci\`{e}re makes between the \emph{strategic} and \emph{aesthetic} notions of the avant-garde. Therefore, if one is to make a connection between politics and music, two types of musical \mbox{avant-gardes} have to be considered. The first should be a musical avant-garde that---through new ways of creating musical forms and structures that are crucially \emph{perceived} as radical by the community---has the capacity to inspire and encourage new forms of political thought about the life to come. The second type of musical avant-garde is one that can be associated to a particular circle of people, institution or movement that consolidates a type of subjectivity. It is important to remember that the manifestation of a common ideological position is what triggers the conception of this type of group.\footnote{Slovoj Zizek has repeatedly emphasized how ideology is not an abstract notion or theory one simply ascribes to, but it is a type of subjectivity that is reflected in the way we act, on what we do and how we carry on living our lives. Therefore, a musical `movement' doesn't necessarily have to be one in which there is a `conscious' or openly declared agenda that follows a particular ideology.} The \emph{aesthetic} and \emph{strategic} notions of the musical avant-garde are of course related but only in what it is concerned to music. Moreover, the second type should not be confused by the first type in as much as it will lead to further misunderstandings within the music-world. Additionally, the second type of musical avant-garde is useful to the political avant-garde only in as much as it contributes to the first type of musical avant-garde in the creation of `new sensible forms and structures.'
