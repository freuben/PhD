...
\end{quote}
Small's interest lies particularly on the collective action of music making and defines this activity as \emph{musicking}. By giving priority to the verb \emph{musicking}, as opposed to the noun \emph{music}, he questions the notion of the `musical work' and emphasizes the importance on the human act of \emph{musicking} and the relationships that are established while it takes place.
 
, meaning all individual and collective endeavors in the process of music making. Moreover, Small questions the notion that a musical work is what gives meaning to \emph{musicking}. 
