...
I believe that a central concern within my work is addressing the importance of redefining what \emph{radical music} is today. This urgency comes from a set of preoccupations that relate to the skeptical, pragmatic and often cynical attitude towards radical thought in music creation and reception today. However, I believe this attitude is dominant not without a reason---it has to do with the notion that today music is defined negatively. Alain Badiou has clearly expressed this view in his essay entitled `Scholium: A Musical Variant of the Metaphysics of the Subject.'
\begin{quote}
...
Here, Badiou precisely delineates the situation of the status-quo in music, where the only two main options seem to embrace either the joyful and permissive attitude towards mixing genres and styles now commonly ascribed to \emph{postmodernism} or the desolate notion of \emph{modernist} aesthetics that to this day heroically stands in life support for more than thirty years. These two positions also seem unable to respond to the original premise of the musical avant-garde, which establishes a connection between music and radical thought. It is for this reason, that I believe \emph{radical music} today can not be defined by neither the anti-mimetic notion of \emph{modernism} nor its reaction, that now---under the \emph{postmodern} banner---challenges the emancipatory potential of music, its autonomy and its capacity to accomplish. 
 ...
 to briefly examine the current position of music in contemporary culture in order to understand why the \emph{aesthetic regime} in music is apparently not well received by the community. Additionally, I will propose that there should be a redefinition of the musical avant-garde
...
It is for this reason that I believe \emph{radical music} today can not be defined by neither the anti-mimetic notion of \emph{modernism} nor its reaction that now---under the \emph{postmodern} banner---challenges the emancipatory potential of music, its autonomy and its capacity to accomplish. 

It is then crucial that \emph{radical music} be

 and at the same time handicapped by on the one hand 
of the confusion Ranciere has described caused by the  the two different ideas of artistic subjectivity. 

either the confusion ascribed to the notion of \emph{modernism} as expressed in serialism
