...
The writing computer applications has been an integral process in relationship with the submitted creative work. Thus, the development of computer applications has run simultaneously with my aesthetic and creative research. From the very start of composition and conception until the performance and realization, the computer applications that have been developed and the artistic output have merged within a single creative process. Therefore, my practice during the research period has become deeply connected to computer programming and the use of computer applications. It is worth mentioning that the applications developed as part of the creative process have particularly influenced the \emph{musical result} of the creative output and now encompass an important aspect of my musical practice. In addition, these applications have been developed for musical purposes and therefore understanding how they work might give an insight into the submitted work. Furthermore, I would like to clarify that these applications do not serve a function beyond the realization of the idiosyncratic elements that constitute my creative process. In other words, these applications were written only with an artistic and musical purpose and therefore they do not aim at contributing to the technological developments of computer music. Instead, they only represent a set of tools and documentation that other artists, musicians and composers might find useful for their own practice.
