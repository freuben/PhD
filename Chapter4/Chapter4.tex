...
\begin{figure}[htbp] %  figure placement: here, top, bottom, or page
   ...
   \label{fig:example}
\end{figure}\
The \emph{notes} message takes as input one array of notes, one of positions and one of colors. If the array of positions is not specified, then the computer   
\begin{figure}[htbp] %  figure placement: here, top, bottom, or page
   \centering
