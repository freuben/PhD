...
The introduction of the computer in live musical performance offers the possibility to establish new relationships regarding the way in which we perceive a musical performance. The causality inherent in traditional music produced with mechanical means,\footnote{This includes the traditional means of producing vocal, instrumental and mechanical music.} which follows `well-understood Newtonian mechanics of action and reaction, motion, energy, friction and damping,'\footnote{\hyperlink{emmersonliving}{Emmerson (2009)}, p. xiv.} does not need to apply to live electronic music performance. In electronic music, the casual relationships found in our acoustic surroundings may not be clearly revealed, given that sound may be produced with little evidence of mechanical production (with the exception of the vibrating cone of the loudspeaker). Nevertheless, considering music performance involves conventions that include complex social and cultural aspects as well other activities that we associate to our individual experience, we seek---either as listeners or music-makers---to create relationships in electronic music performance that relate to our human condition. Given the fact that most of our sonic experience is within our acoustic surroundings, we usually seek to form casual relationships, even within the electronic medium (which does not need to reveal a clear relationship between the sound and the way it is produced). Therefore, many efforts have been made to reestablish casual relationships that are characteristic of traditional music performance through mechanical means in electronic music performance through the continuing development of interfaces that attempt to reestablish an instrumental approach to electronic music (for example synthesizers, MIDI samplers, electric guitars, \emph{etc}). Nevertheless, electronic music performance also offers the opportunity of forming other types of relationships as perceived by the listener. This specific feature of the electronic medium may challenge the conventional notions of a musical performance as it may form new types of relationships that go beyond the traditional instrumental approach. Therefore, when dealing with electronic music performance, the composer may decide what types of relationships he/she wants to establish (for instance, how different sonic and visual aspects of a performance may relate to each other or how the human body and movement may be associated to sound). 

Simon Emmerson, in his book \emph{Living electronic music}, describes different approaches the musician may take towards electronic music performance based on how the audience may perceive the actions of the human performer in relationship to the sounding result. First he describes what he calls the `Local/Field Distinction', in an attempt to conceptualize differently relationships that seem to have a perceived causality between a human performer's action and a sounding result, and those that don't.
\begin{quote}
\emph{Local} controls and functions seek to extend (but not to break) the perceived relation of human performer action to sounding result. \emph{Field} functions creat a context, a landscape or an environment within which \emph{local} activity may be found. It is important to emphasize that the \emph{field} as defined above \emph{can contain other agencies}, in other words, it is not merely a `reverberant field' in the crude sense but an area n which the entire panoply of both pre-composed and real-time electro-acoustic music may be found. . . . This definition aims to separate out the truly live element as clearly the `local agency' in order to re-form more coherently the relationship with this open stage area, which may surround the audience and extend outside.
\end{quote}

In addition to this distinction, he also makes a difference between \emph{real} and \emph{imaginary} relationships that may be \emph{local} or \emph{field}.

 regarding what appears to be true to the listener. the appearance of what .

Additionally, technology may facilitate new modes of performance through computer-mediated group interaction in which traditional relationships and performance-practice conventions within an ensemble may change.

been made that at controlling other aspects 

this kind of casual relationship is `imaginary', in as much as the actual sound that is heard is actually not produced by the acoustic action 

 to MIDI controllers, sensors well as other more sophisticated systems to track human gesture through computers.


we seek to form `imaginary' relationships in electronic music as well,


Given that a musical performance is a social event, we seek to form relationships 

within our cultural context involves a certain amount of 

is a social event which we seek relationships in performance . . . .

Nevertheless, many attempts have been i what constitutes a musical performance 

Therefore, when thinking about live musical performance using electronics, important questions arise from the observation that electronic music gives little evidence of the causality inherent within the acoustic medium: what constitutes a live electronic music performance? how do we know it is `fixed' or `live'? how should live electronic music be performed?

Iteration?

. . . fundamental question, mainly, how should live electronic music be performed? This question 

Simon Emmerson, in his book \emph{Living electronic music}, addresses this issue and describes it as establishes a difference between what he calls \emph{local} and \emph{field} agencies.

Efforts have been attempted to build interfaces and `electronic instruments' to re-establish the visual/aural causality of instrumental music within the electronic medium. Nevertheless, this effort has been ignored by the people who believe that `acousmatic' listening is a valid alternative.  
...
Live electronic performance... (Living electronic music) Issues concerning electronic music performance, Acoustic world: Newtonian mechanics, etc. real vrs imaginary, ``magic'', Theater, Idiosyncratic approaches, etc.
...
Code, no score, internet documentation (git)---collaborative opportunities, etc...
