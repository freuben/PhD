...
The introduction of the computer in live musical performance offers the possibility to establish new `imaginary' relationships regarding the way in which we perceive a musical performance. Additionally, technology may facilitate new modes of performance through computer-mediated group interaction in which traditional relationships and performance-practice conventions within an ensemble may change . revise...

.. bit more intro...


The causality inherent in traditional music produced with mechanical means\footnote{This includes the traditional means of producing vocal, instrumental and mechanical music.}, which follows `well-understood Newtonian mechanics of action and reaction, motion, energy, friction and damping,'\footnote{\hyperlink{emmersonliving}{Emmerson (2009)}, p. xiv.} does not necessarily apply to live electronic music performance. In electronic music, the casual relationships found in our acoustic surroundings may not be clearly revealed, given that sound may be produced with little evidence of mechanical production (with the exception of the vibrating cone of the loudspeaker). Nevertheless, we seek relationships in performance . . . .
