...
\end{quote}
Consequently, \v{Z}i\v{z}ek implies that we not only form \emph{interactive}, but also \emph{interpassive} relationships with technological objects. In other words, while the standard position regarding how we relate to technology is that we use its objects for our own purpose, what \v{Z}i\v{z}ek suggests is that today technological objects might actually demand something from us, instead of just serving us. Therefore, the `user' not only \emph{uses} technology, but is also \emph{used} by technology. Furthermore, \v{Z}i\v{z}ek claims that \emph{interpassivity} implies that while we are obsessively active by the object's demands, we also rely on the object to be passive for us. This transfer implies a game that goes on in our minds, in which we imagine the object as the Other, whose desire we subvert through our activity in order to put off our recognition that enjoyment cannot be achieved fully. It is for this reason that---according to \v{Z}i\v{z}ek---the notion of \emph{interpassivity} is vital in understanding the artistic possibilities of digital technology.\footnote{See Ibid., pp. 104-110.} 

\v{Z}i\v{z}ek's definitions may also be applied to the way in which a performer might relate to technology in a live electronic musical performance. The performer therefore might form \emph{interactive} relationships with the technological object when he/she seems to remain passive while technology appears to be active. For instance, when a performer plays a note or presses a button that sets an active chain of sound, or the `typical' laptop performer's role of sitting behind the computer appearing to be passive while triggering musical events that suggest activity. In addition, the performer might also form \emph{interpassive} relationships with technology, when the technological object appears to remain passive while making the performer appear franticly active. This concept hasn't been explored thoroughly by composers using technology but can be found for example in cases were the performer receives directions from a technological object (through a computer display or through headphones) directing the performer towards frenetic activity. Musical applications that establish \emph{interpassive} relationships between performer and technological objects I think could be further developed in computer-mediated performances and through more experimental methods, such as involuntary bodily movement\footnote{See Stelarc} or by radically altering the sound of a performer playing an electronic instrument, such that the initial physical effort of the performer is reduced or striped to silence by the computer processing (giving the impression of human activity being subverted through technology, which remains passive). 

Also relationship with Audience

Additionally, the performer might also establish \emph{interactive} as well as \emph{interpassive} relationships with the audience through technology.
