...
(These implications) also relate to a more fundamental question, mainly, how should live electronic music be performed? This question has already generated a complex debate which originates from a specific feature of electronic music: it does not (need to) reveal visually indications that within our acoustic surroundings normally have a clear visual (cause) to aural (effect) relationship. The visual/aural causality of the acoustic medium is also characteristic of most instrumental and vocal music, which also depends on `well-understood Newtonian mechanics of action and reaction, motion, energy, friction and damping'.\footnote{\hyperlink{emmersonliving}{Emmerson (2009)}, p. xiv.} 
...
Simon Emmerson in his book \emph{Living electronic music} outlines the basic types of
